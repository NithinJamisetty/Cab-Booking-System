...
def RegisterPage():
    ...
    canvas.create_rectangle(90,100,430,550,fill="#550A35",outline="white")
    ...
    Loginbutton=Button(canvas,text="Login",fg="white",bg="#088",bd=0,font=("Arial",13,'bold'),command=loginpage)
...
def feedpage():
    ...
    rebutton=Button(canvas,text="booking page",width=15,fg="white",bg="#a542db",bd=0,font=("Arial",13,'bold'),command=gotocpage)
    ...
    var.set(1)
    secmenu=  ttk.Combobox(root, width=30,height=20,textvariable=var)
    secmenu['values'] =list(range(1,5))
    secmenu['state'] = 'readonly'
    feedEntry=Text(canvas, height=10, width=65,fg='White',bg="#a542db",bd=4,font=("Arial",10,'italic'))
...
def forgotpage():
    ...
    backgroundIMG=PhotoImage(file="background.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="#550A35",outline="white")
...
def cabbook():
    ...
    canvas.create_rectangle(0,0,1366,200,fill="purple",outline="purple")
    canvas.create_rectangle(590,200,890,500,fill="white")
    canvas.create_text(20,30,text="NHVCabs",fill='white',font=("bauhaus 93",25),anchor=NW)
    ...
    canvas.pack()
    detbutton=Button(canvas,text="View Past booking",width=15,fg="white",bg="purple",bd=0,font=("Arial",13,'bold'),command=viewbooking)
    canvas.create_window(1200,90,window=detbutton)
    lobutton=Button(canvas,text="Logout",width=15,fg="white",bg="grey",bd=0,font=("Arial",13,'bold'),command=loginpage)
    canvas.create_window(1200,180,window=lobutton)
    cpbutton=Button(canvas,text="Change your Password",width=20,fg="white",bg="purple",bd=0,font=("Arial",13,'bold'),command=changepasswordpage)
    canvas.create_window(1200,120,window=cpbutton)
    revbutton=Button(canvas,text="Review",width=20,fg="white",bg="purple",bd=0,font=("Arial",13,'bold'),command=feedpage)
    canvas.create_window(1200,150,window=revbutton)
    root.mainloop()
def cadminlogin():
    global userEntered
    global passEntered
...
def loginpage():
    ...
    canvas.create_window(350,450,window=Regbutton)
    forgbutton=Button(canvas,text="Forgot Password",fg="white",bg="#550A35",bd=0,font=("Arial",10,'underline'),command=forgotpage)
    canvas.create_window(280,380,window=forgbutton)
    abutton=Button(canvas,text="Admin Login",fg="white",bg="#550A35",bd=0,font=("Arial",10,'underline'),command=adminloginpage)
